...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for each in livingGhostPositionDistributions:
            position = each.argMax()
            tempDistance = self.distancer.getDistance(pacmanPosition, position)
        ...
        for action in legal:
            ...
            tempDistance2 = self.distancer.getDistance(successorPosition, ghostPosition)
